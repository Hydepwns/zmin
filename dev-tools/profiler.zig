...
pub fn main() !void {
    ...
    while (i < args.len) : (i += 1) {
        ...
        if (std.mem.eql(u8, arg, "--input") or std.mem.eql(u8, arg, "-i")) {
            if (i + 1 >= args.len) {
                reporter.report(DevToolError.MissingArgument, errors.contextWithDetails("profiler", "parsing arguments", "Missing input file path"));
            ...
            if (i + 1 >= args.len) {
                reporter.report(DevToolError.MissingArgument, errors.contextWithDetails("profiler", "parsing arguments", "Missing output file path"));
                return DevToolError.MissingArgument;
            }
            ...
            if (i + 1 >= args.len) {
                reporter.report(DevToolError.MissingArgument, errors.contextWithDetails("profiler", "parsing arguments", "Missing JSON output file path"));
                return DevToolError.MissingArgument;
            }
            ...
            if (i + 1 >= args.len) {
                reporter.report(DevToolError.MissingArgument, errors.contextWithDetails("profiler", "parsing arguments", "Missing iteration count"));
                return DevToolError.MissingArgument;
            }
            ...
            reporter.report(DevToolError.UnknownCommand, errors.contextWithDetails("profiler", "parsing arguments", arg));
