...
pub const TurboMinifier = struct {
    ...
    pub fn minifyWithStrategy(self: *Self, input: []const u8, strategy_type: StrategyType, config: TurboConfig) !MinificationResult {
    ...
    fn getStrategy(_: *Self, strategy_type: StrategyType) !*const TurboStrategy {
    ...
    pub fn estimatePerformance(self: *Self, input_size: u64, strategy_type: StrategyType) !u64 {
        const strategy = try self.getStrategy(strategy_type);
