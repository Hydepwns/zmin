...
pub const TestPatterns = struct {
    ...
    pub const basic_types = [_][]const u8{ "0", "\"\"", "{}", "[]", "true", "false", "null" };

    pub const whitespace_only = [_][]const u8{ " ", "\t", "\n", "\r", "   \t\n\r   " };

    pub const invalid_literals = [_][]const u8{ "tru", "truee", "fals", "falsee", "nul", "nulll", "True", "False", "Null", "TRUE", "tree", "fulse" };

    pub const invalid_numbers = [_][]const u8{ "-", "01", "1.", "1e", "1e+", "1.2.3", "1ee2", "1e2e3", "+1" };

    pub const invalid_escapes = [_][]const u8{ "\"\\x\"", "\"\\\"", "\"test", "\"\\u\"", "\"\\u123\"", "\"\\u123g\"", "\"\\uXYZ1\"" };
